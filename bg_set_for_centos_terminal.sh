...
gconftool-2 --set "/apps/gnome-terminal/profiles/Profile0/palette" --type string "$PALETTE"
gconftool-2 --set "/apps/gnome-terminal/profiles/Profile0/background_color" --type string "$BG_COLOR"
gconftool-2 --set "/apps/gnome-terminal/profiles/Profile0/foreground_color" --type string "$FG_COLOR"
